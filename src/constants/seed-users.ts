...
export const usersSeed: Partial<UserItem>[] = [
  { firstname: 'Juan Manuel', lastname: 'Ferreira Pérez', username: 'juan', email: 'juan@example.com', status: 1 },
  { firstname: 'María de la Caridad', lastname: 'Chávez Quesada', username: 'maria', email: 'maria@example.com', status: 1 },
  { firstname: 'Luis Gabriel', lastname: 'Hernández Pupo', username: 'luis', email: 'luis@example.com', status: 1 },
  { firstname: 'Ana María', lastname: 'Pupo Gracia', username: 'ana', email: 'ana@example.com', status: 1 },
  { firstname: 'NimbleAI', lastname: '', username: 'nimbleai', email: 'nimbleai@example.com', status: 1, admin: true }
];

export const interfacesSeed: InterfaceItem[] = [
  { persistant: true, name: 'Home', route: '/', icon: 'home', description: 'Pantalla de Bienvenida', config: {} },
  { persistant: true, name: 'Vistas', route: '/admin/interfaces', icon: 'settings', description: '', config: {} },
  // { persistant: true, name: 'Navegación', route: '/admin/navigation/menu-items/', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Íconos', route: '/admin/navigation/icons', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Menús de Navegación', route: '/admin/navigation/menu-items', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Esquema', route: '/admin/schema', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Entidades', route: '/admin/entities', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Reglas', route: '/admin/rules', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Automatización', route: '/admin/automatization', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Notificaciones', route: '/admin/notifications', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Asistente', route: '/admin/assistant', icon: 'settings', description: '', config: {} },
  { persistant: true, name: 'Usuarios', route: '/admin/users', icon: 'settings', description: '', config: {} },
...
export const menuItemsSeed: MenuItem[] = [
  ...
  { name: 'Vistas', identifier: 'interfaces', icon: 'settings', description: 'Gestionar las interfaces de la aplicación', interface_id: '/admin/interfaces', parent_id: 'admin', is_fast_link: true, position: 3 },
  { name: 'Navegación', identifier: 'navigation', icon: 'settings', description: 'Gestionar los elementos de navegación', interface_id: '/admin/navigation/menu-items', parent_id: 'admin', is_fast_link: true, position: 3 },
  { name: 'Esquema', identifier: 'schema', icon: 'settings', description: 'Gestionar el esquema de la base de datos', interface_id: '/admin/schema', parent_id: 'admin', position: 3 },
  { name: 'Entidades', identifier: 'entities', icon: 'settings', description: 'Gestionar Entidades de las entidades', interface_id: '/admin/entities', parent_id: 'admin', position: 3 },
  { name: 'Reglas', identifier: 'organization_rules', icon: 'settings', description: 'Configurar el asistente de IA', interface_id: '/admin/assistant', parent_id: 'admin', position: 3 },
  { name: 'Automatización', identifier: 'automatization', icon: 'settings', description: 'Gestionar automatización de procesos', interface_id: '/admin/automatization', parent_id: 'admin', position: 3 },
  { name: 'Notificaciones', identifier: 'notifications', icon: 'settings', description: 'Gestionar sistema de notificaciones', interface_id: '/admin/notifications', parent_id: 'admin', position: 3 },
  { name: 'Asistente', identifier: 'assistant', icon: 'settings', description: 'Gestionar el asistente de IA', interface_id: '/admin/assistant', parent_id: 'admin', position: 3 },
  { name: 'Usuarios', identifier: 'users', icon: 'settings', description: 'Gestionar usuarios y permisos', interface_id: '/admin/users', parent_id: 'admin', position: 3 },
...
export const iconsSeed = [
  ...
  },
  {
    name: 'bulk-add',
    svg_content: `
    <g class="text-gray-900 dark:text-white>
  ...
  },
  {
    ...
    svg_content: `
      ...
      <path d="M18 16L14 12L8 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M20 18L16 14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
    `,
  ...
  {
    name: 'db-entity',
    svg_content: ` <rect x="6" y="4" width="12" height="16" rx="1" stroke="currentColor"></rect>
      <path d="M6 8H18" stroke="currentColor"></path>
      <rect x="6" y="4" width="12" height="4" fill="currentColor" fill-opacity="0.6"></rect>
      <circle cx="18" cy="14" r="1.5" fill="currentColor" stroke-width="2"></circle>
    `,
  ...
  },
  {
    ...
    `,
    description: 'Valor decimal (o flotante)',
    fill: '',
    stroke: ''
  },
  {
    ...
    svg_content: `
      ...
      <circle cx="15.5" cy="12" r="4" fill="currentColor" fill-opacity="0.4"></circle>
    `,
    description: 'Valor booleano: verdadero o falso',
    fill: '',
    stroke: ''
  },
  {
    ...
    `,
    description: 'Valor de una lista',
    fill: '',
    stroke: ''
  },
  {
    ...
    `,
    description: 'Relación o referencia a otro objeto',
    fill: '',
    stroke: ''
  },
  {
  ...
  },
  {
    ...
    svg_content: `
      ...
      <path d="M13 15h3"/>
    `,
    description: 'Fecha o calendario',
    fill: '',
    stroke: ''
  },
  {
