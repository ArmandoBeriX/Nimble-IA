...
// 🟣 Púrpura (#a855f7) — Navegación / UI:     interfaces, menu_items, icons
...
export const TablesSpec: TableDef[] = [
  ...
  },
  {
    ...
    tableFields: [
      ...
      },
      {
        ...
        fieldFormat: FieldFormat.JSON, multiple: false, isEditable: true
      },
      {
        id: crypto.randomUUID(),
        tableIdentifier: 'table_fields',
      ...
      {
        id: crypto.randomUUID(), tableIdentifier: 'table_fields', identifier: 'storeData', name: 'Data',
  ...
  },
  {
    ...
    tableFields: [
      ...
      {
        id: crypto.randomUUID(), tableIdentifier: 'settings', identifier: 'storeData', name: 'Datos Personalizados',
  ...
  },
  {
    ...
    tableFields: [
      ...
      },
      {
        ...
        fieldFormat: FieldFormat.JSON, multiple: false, isRequired: false, isFilter: false, isUnique: false, isEditable: true
      },
      {
