  ...
  const renderLoggedUser = () => (
    <Show when={user}>
      <div class="flex items-center">
        <Button
          variant="ghost"
          onClick={(e) => openUserContextMenu()}
          class="flex items-center space-x-2 px-2 py-1.5 rounded-lg hover:bg-gray-100 transition-colors"
        >
          <div class="relative">
          ...
          <div class="hidden lg:flex flex-col items-start">
            <strong class="text-sm font-semibold text-gray-900">{user?.login}</strong>
