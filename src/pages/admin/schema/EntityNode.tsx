    ...
    >
      ...
      >
                ...
                <WithTooltip
                  tooltip={
                    <div class="flex flex-col gap-1">
                      ...
                      <div class="text-xs opacity-80 leading-snug line-clamp-2">
              ...
              return (
                ...
                >
                  <div class="flex items-start gap-1.5">
                    ...
                    {/* Field actions */}
                    <div class="field-actions flex items-center hidden group-hover:block absolute right-[-48px] shadow-md top-1/2 -translate-y-1/2 bg-white/80 backdrop-blur-sm rounded-md px-1">
                      <RecordButtonAction
        ...
        <Show when={showActions()}>
          <div class="border-t border-gray-100 px-3 py-1.5 w-full">
            <RecordButtonAction
              tableIdentifier="table_fields"
              action="create"
              modalProps={{ onConfirm: props.onChange }}
